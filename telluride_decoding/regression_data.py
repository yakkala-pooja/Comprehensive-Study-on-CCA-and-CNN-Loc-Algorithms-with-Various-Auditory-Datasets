...
class DataLocation(object):
  internet = attrs.field(type=Text)   # Original source of data on Internet
  cache_dir = attrs.field(type=Text)   # Loc. of local copy of original data
  tf_dir = attrs.field(type=Text)  # Location of local ingested TFRecord copy
  desired_frame_rate = attrs.field(type=float)  # Frame rate for the data
  data_type = attrs.field()    # Which Regression class provides default params
