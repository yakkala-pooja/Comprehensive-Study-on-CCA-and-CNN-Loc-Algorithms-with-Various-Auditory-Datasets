...
# Use attrs for class definition
@attrs.define
class DecodingOptions(object):
  """A class encapsulating all the parameters for a decoding experiment."""
  attended_field = attrs.field(init=False, type=Text, default='attend')
  batch_norm = attrs.field(init=False, type=bool, default=False)
  batch_size = attrs.field(init=False, type=int, default=512)
  cca_dimensions = attrs.field(init=False, type=int, default=10)
  check_file_pattern = attrs.field(init=False, type=Text, default='')
  correlation_frames = attrs.field(init=False, type=int, default=100)
  correlation_reducer = attrs.field(init=False, type=Text, default='lda')
  data = attrs.field(init=False, type=Text, default='tfrecords')
  debug = attrs.field(init=False, type=bool, default=False)
  dnn_regressor = attrs.field(init=False, type=Text,
                          default='fullyconnected')
  dropout = attrs.field(init=False, type=float, default=0.0)
  epoch_count = attrs.field(init=False, type=int, default=100)
  frame_rate = attrs.field(init=False, type=float, default=100.0)
  hidden_units = attrs.field(init=False, type=Text, default='20-20')
  input2_field = attrs.field(init=False, type=Text, default='')
  input2_post_context = attrs.field(init=False, type=int, default=0)
  input2_pre_context = attrs.field(init=False, type=int, default=0)
  input_offset = attrs.field(init=False, type=int, default=0)
  input_field = attrs.field(init=False, type=Text, default='mel_spectrogram')
  learning_rate = attrs.field(init=False, type=float, default=0.05)
  loss = attrs.field(init=False, type=Text, default='mse')
  min_context = attrs.field(init=False, type=int, default=0)
  output_field = attrs.field(init=False, type=Text, default='envelope')
  post_context = attrs.field(init=False, type=int, default=0)
  pre_context = attrs.field(init=False, type=int, default=0)
  random_mixup_batch = attrs.field(init=False, type=bool, default=False)
  regularization_lambda = attrs.field(init=False, type=float, default=0.1)
  saved_model_dir = attrs.field(init=False, type=Text, default=None)
  shuffle_buffer_size = attrs.field(init=False, type=int, default=100000)
  summary_dir = attrs.field(init=False, type=Text, default='/tmp/tf')
  tensorboard_dir = attrs.field(init=False, type=Text, default=None)
  test_file_pattern = attrs.field(init=False, type=Text, default='')
  test_metric = attrs.field(init=False, type=Text,
                        default='pearson_correlation_first')
  tfexample_dir = attrs.field(init=False, type=Text, default=None)
  tfexample_pattern = attrs.field(init=False, type=Text, default='')
  train_file_pattern = attrs.field(init=False, type=Text, default='')
  validate_file_pattern = attrs.field(init=False, type=Text, default='')
  ...
  def experiment_parameters(
    ...
    Returns:
      ...
      the delimiter.
    """
    new_params_as_dict = attrs.asdict(self)
...
def run_decoding_experiment(
  ...
  test_model.summary()
  test_model.add_metadata(attrs.asdict(my_flags), dataset=some_dataset)
